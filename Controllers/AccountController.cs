    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    UserProfile user = db.UserProfiles.FirstOrDefault(u => u.User_Name.ToLower() == model.UserName.ToLower());
                    // Check if user already exists
                    if (user == null)
                    {
                        // Insert name into the profile table
                        db.UserProfiles.Add(new UserProfile { User_Name = model.UserName });
                        db.SaveChanges();
        ...
        //
        // GET: /Artist/DetailsUserProfile/5
        [Authorize]
        ...
        //
        // GET: /Artist/EditUserProfile/5
        [Authorize]
        public ActionResult EditUserProfile(int id = 0)
        {
            using (UsersContext db = new UsersContext())
            {
        ...
        public ActionResult EditUserProfile(UserProfile userProfile)
        {
            using (UsersContext db = new UsersContext())
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    return PartialView("DetailsUserProfile", userProfile);
                }
                else
                {
