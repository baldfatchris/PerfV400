...
namespace PerfV400.Models
{
    ...
    public partial class PerfV100Entities : DbContext
    {
        ...
        public DbSet<PhotoAgent> PhotoAgents { get; set; }
        public DbSet<PhotoArtist> PhotoArtists { get; set; }
        public DbSet<PhotoBand> PhotoBands { get; set; }
        public DbSet<PhotoEvent> PhotoEvents { get; set; }
        public DbSet<PhotoPerformance> PhotoPerformances { get; set; }
        public DbSet<PhotoProduction> PhotoProductions { get; set; }
        public DbSet<PhotoReview> PhotoReviews { get; set; }
        public DbSet<PhotoVenue> PhotoVenues { get; set; }
